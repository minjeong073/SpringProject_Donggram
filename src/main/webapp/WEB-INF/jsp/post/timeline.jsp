			...
			<div>
				...
				<div id="feed" class="feed border m-3" value="${postDetail.post.id }">
					...
					<div class="user-info-box border d-flex align-items-center">
						...
						<!-- 사용자 정보 -->
						<a href="/user/feed/view?id=${postDetail.user.id }" id="user-img" class="col-2 d-flex align-items-center text-dark">
						...
						<div id="user-name" class="col-3">
							<a href="/user/feed/view?id=${postDetail.user.id }" class="text-dark"><h4>${postDetail.user.loginId }</h4></a>
						</div>
						...
						<c:choose>
							<c:when test="${postDetail.user.id eq userId }">
								...
								<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
									<a class="dropdown-item" href="/post/detail/view?id=${postDetail.post.id }">수정</a>
								</div>							
							</c:when>
							<c:otherwise>
